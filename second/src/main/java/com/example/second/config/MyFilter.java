...
MyFilter implements FilterInvocationSecurityMetadataSource {
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        ...
        if(requestUrl.startsWith("/journalism") || requestUrl.startsWith("/evangel") || requestUrl.startsWith("/special")
        || requestUrl.startsWith("/science") || requestUrl.startsWith("/subject") || requestUrl.startsWith("/message"))
        {
            return null;
        }
